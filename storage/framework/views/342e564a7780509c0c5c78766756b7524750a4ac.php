...
} elseif ($_instance->childHasBeenRendered('rSkhFXC')) {
    $componentId = $_instance->getRenderedChildComponentId('rSkhFXC');
    $componentTag = $_instance->getRenderedChildComponentTagName('rSkhFXC');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('rSkhFXC');
} else {
    $response = \Livewire\Livewire::mount('navbar', []);
    $html = $response->html();
    $_instance->logRenderedChild('rSkhFXC', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <main class="max-w-6xl mx-auto">
            ...
            <div class="min-h-6x1 lg:py-52 xs:py-28 left-1/2">
                ...
                <p class="text-3xl font-extrabold text-white tracking-wide select-none">
                    <span
                        ...
                        <?php echo e($profile[0]['firstname']); ?> <?php echo e($profile[0]['name']); ?>
        ...
        <section class="" id="information">
            ...
            <div class="flex xs:flex-col pt-36 mx-auto">
                <div class="lg:flex-row xs:flex-col mx-auto ">
                    <h2 class="lg:text-4xl xs:text-2xl font-extrabold text-white"><?php echo e($profile[0]['firstname']); ?>

                        <?php echo e($profile[0]['name']); ?>,</h2>
                    <p class="my-4 text-lg text-gray-500 "><?php echo e($profile[0]['biography']); ?></p>
                </div>
                <div class="lg:flex-row xs:flex:col mx-auto">
                    <dl class="max-w-md text-gray-900 divide-y divide-blue-400">
                        <div class="flex flex-col pb-3">
                            ...
                            <dd class="text-lg font-semibold text-gray-500 select-all"><?php echo e($profile[0]['email']); ?></dd>
                        </div>
                        <div class="flex flex-col pt-3">
                            <dt class="mb-1 text-white md:text-lg dark:text-gray-400 select-none">Numéro de téléphone
                            </dt>
                            <dd class="text-lg font-semibold text-gray-500 select-all"><?php echo e($profile[0]['phone']); ?></dd>
                        </div>
                    </dl>
                </div>
            </div>
        ...
        <section class="min-h-screen" id="formation">
            ...
            <?php $__currentLoopData = $etudes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $etude): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="pt-16 justify-center flex" id="<?php echo e($etude['name']); ?>">
                            ...
                            <div class="lg:flex lg:flex-row pt-5">
                                <div class="">
                                    <h2 class="lg:text-2xl xs:text-lg font-extrabold text-white">
                                        <?php echo e($outil['title']); ?>,</h2>
                                    <p class="my-4 lg:text-lg xs:text-base text-gray-500 "><?php echo e($outil['description']); ?></p>
                                </div>
                            ...
                            <div class="flex w-full">
                                <div class="flex-row">
                                    <h2 class="lg:text-2xl xs:text-base font-extrabold text-white">
                                        <?php echo e($competence['title']); ?>,</h2>
                                    <div class="flex flex-row select-none">
                                        <p class="my-4 lg:text-lg xs:text-sm font-bold text-gray-500 select-none">Niveau de maitrise
                                            : </p>
                                        <?php for($index_lvl = 0; $index_lvl < 5; $index_lvl++): ?>
                                            <?php if($index_lvl < $competence['lvl']): ?>
                                ...
                                <div class="flex-row pl-24 select-none ml-auto">
                                    <img src="/Languages/<?php echo e($competence['logo']); ?>"
                                        alt="logo <?php echo e($competence['logo']); ?>" class="lg:w-24 lg:h-24 xs:w-16">
                                </div>
                    ...
                    <?php $__currentLoopData = $experiences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $experience): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="pt-10 flex-col">
                            <div class="flex ">
                                <div class="">
                                    <h2 class="lg:text-2xl xs:text-lg font-extrabold text-white">
                                        <?php echo e($experience['title']); ?>,</h2>
                                    <p class="my-4 text-lg text-gray-500 "><?php echo e($experience['description']); ?></p>
                                </div>
                                <div class="">
                                    <dl class="max-w-md text-gray-900 divide-y divide-blue-400">
                                        <div class="flex flex-col pb-3 pt-5">
                                            ...
                                            <dd class="text-sm text-right font-semibold text-gray-500 select-all">
                                                <?php echo e(implode(', ', $experience['competences'])); ?>
                            ...
                            <div class="pt-16">
                                <div class="lg:flex lg:flex-row lg:divide-x-2 xs:divide-y-2 divide-blue-400">
                                    ...
                                    <div>
                                        <?php $__currentLoopData = $etudes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $etude): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($etude['id'] == $experience['etude_id']): ?>
                                                <div class="pb-3 px-8">
                                                    <dt
                                                        class="mb-1 text-white md:text-lg dark:text-gray-400 select-none">
                                                    </dt>
                                                    <dd class="text-sm font-semibold text-gray-500 select-none">
                                                        <a href="#<?php echo e($etude['name']); ?>"><?php echo e($etude['name']); ?></a>
                                                    </dd>
                                                </div>
                                            <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\laragon\www\stage\portfolio-app\resources\views/welcome.blade.php ENDPATH**/ ?>