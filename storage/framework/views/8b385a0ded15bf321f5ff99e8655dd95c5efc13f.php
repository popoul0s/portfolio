...
} elseif ($_instance->childHasBeenRendered('a9yzP13')) {
    $componentId = $_instance->getRenderedChildComponentId('a9yzP13');
    $componentTag = $_instance->getRenderedChildComponentTagName('a9yzP13');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('a9yzP13');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('a9yzP13', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH C:\laragon\www\stage\portfolio-app\vendor\filament\filament\src\/../resources/views/components/layouts/card.blade.php ENDPATH**/ ?>