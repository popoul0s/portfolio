...
<div class="fixed w-full z-20 bg-background pt-2">
    <div class="text-center">
        <button class="text-white font-medium rounded-lg text-sm px-5 py-2.5 border" type="button"
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="#competence"
                    ...
                    <span class="flex-1 ml-3 whitespace-nowrap">Compétences</span>
                </a>
            </li>
            <li>
                <a href="#experience"
                    ...
                    <span class="flex-1 ml-3 whitespace-nowrap">Expériences</span>
                </a>
            </li>
                ...
                <?php if(auth()->guard()->check()): ?>
                    <li>
                        <a href="<?php echo e(url('/admin')); ?>"
                            ...
                            <span class="ml-3">Admin Pannel</span>
                        </a>
                    </li>
                <?php else: ?>
                    <li>
                    ...
                    <?php if(Route::has('register')): ?>
                        <li>
                            <a href="<?php echo e(route('register')); ?>"
                                ...
                                <span class="flex-1 ml-3 whitespace-nowrap">S'incrire</span>
                            </a>
                        </li>
                    <?php endif; ?>
                <?php endif; ?>
...
<?php /**PATH C:\laragon\www\stage\portfolio-app\resources\views/livewire/navbar.blade.php ENDPATH**/ ?>