...
<div
    ...
    x-cloak
    <?php echo e($attributes->class(['filament-tables-selection-indicator whitespace-nowrap bg-primary-500/10 px-4 py-2 text-sm'])); ?>
...
<?php endif; ?>
    ...
    <span
        ...
        x-text="window.pluralize(<?php echo \Illuminate\Support\Js::from(__('tables::table.selection_indicator.selected_count'))->toHtml() ?>, selectedRecords.length, { count: selectedRecords.length })"
    ></span>

    <span
        id="<?php echo e($this->id); ?>.table.selection.indicator.record-count.<?php echo e($allSelectableRecordsCount); ?>"
        x-show="<?php echo e($allSelectableRecordsCount); ?> !== selectedRecords.length"
    >
        <button
...
<?php /**PATH C:\laragon\www\stage\portfolio-app\vendor\filament\tables\src\/../resources/views/components/selection-indicator.blade.php ENDPATH**/ ?>