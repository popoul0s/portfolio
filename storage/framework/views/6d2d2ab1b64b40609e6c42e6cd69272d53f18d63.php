...
} elseif ($_instance->childHasBeenRendered('dzt35uM')) {
    $componentId = $_instance->getRenderedChildComponentId('dzt35uM');
    $componentTag = $_instance->getRenderedChildComponentTagName('dzt35uM');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('dzt35uM');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('dzt35uM', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('BRaituX')) {
    $componentId = $_instance->getRenderedChildComponentId('BRaituX');
    $componentTag = $_instance->getRenderedChildComponentTagName('BRaituX');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('BRaituX');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('BRaituX', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\laragon\www\stage\portfolio-app\vendor\filament\filament\src\/../resources/views/components/topbar.blade.php ENDPATH**/ ?>